...
export const PieceForm = ({
  ...
  const componentsOptions = (data) => {
    const objects =
      ...
      data.map((component, index) => ({
        ...
        id: component.serie_number || "",
      }));
    console.log("Objeects", objects);
    objects[0] && onChange(index, "component", objects[0]["id"]);
    return objects;
  };
  const [pieceData, setComponentData] = useState(initialData());
  const [randomKey, setRandomKey] = useState("");
  const [files, setFiles] = useState(pieceData["files"] || []);
  ...
  const [components, setComponents] = useState(
    componentsOptions(componentsData) || []
  );
  ...
  }, [manufacturers, users, providers, states, componentTypes]);
    ...
    <Container>
      ...
      <Form.Group controlId="machine_id" className="mt-4">
        ...
        <Form.Control
          ...
          readOnly
          value={
            machineData["internal_name"] ? machineData["internal_name"] : ""
          }
      ...
      <Form.Group controlId="component" className="mt-4">
        ...
        <Form.Control
          ...
          onChange={(event) => onChange(index, "component", event.target.value)}
        >
          {components.map((u, i) => (
      ...
      <Form.Group controlId="model" className="mt-4">
        ...
        <Form.Group controlId="type" className="mt-4">
          ...
          <Form.Control
            as="select"
            placeholder={"Seleccionar tipo de pieza"}
        ...
        <Form.Group controlId="specifications" className="mt-4">
          ...
          <TextArea
            name="description"
            rows={4}
            value={pieceData["specifications"]}
      ...
      <Form.Group controlId="manufacturerType" className="mt-4">
        ...
        <Form.Control
          as="select"
          onChange={(e) => onChange(index, "manufacturer_type", e.target.value)}
        >
      ...
      <Form.Group controlId="files" className="mt-4">
        <Form.Label>*Archivos Adjuntos de de la pieza</Form.Label>
        <Form.Control
          key={randomKey}
          type="file"
